...
public class RMGrouping implements Cloneable, XMLArchiver.Archivable {
    ...
    public RMSort removeSort(int anIndex)
    {
        ...
        _selSortIndex = Math.min(anIndex, getSortCount() - 1);
