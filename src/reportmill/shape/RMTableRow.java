...
public class RMTableRow extends RMSwitchShape {
    ...
    public void setDeleteVerticalSpansOfHiddenShapes(boolean aValue)
    {
        ...
        if (aValue)
            setShiftShapesBelowHiddenShapesUp(false); // If setting true, turn off shift shapes
    }
    ...
    public void setShiftShapesBelowHiddenShapesUp(boolean aValue)
    {
        ...
        if (aValue)
            setDeleteVerticalSpansOfHiddenShapes(false); // If setting true, turn off delete spans
    }
    ...
    {
        return !isStructured() ? getBoundsLocal() : null;
    }
