 ...
 */
package com.reportmill.pdf.read;
import com.reportmill.pdf.PDFException;
import com.reportmill.pdf.PDFFile;
import com.reportmill.pdf.PDFPage;
import com.reportmill.pdf.PDFStream;
...
public abstract class PDFPattern {
     ...
     */
    public static Shading getShading(String aName, PDFPage aPage)
    {
        Map pat = (Map) aPage.findResource("Shading", aName);
        Shading patobj = Shading.getInstance(pat, aPage.getFile());
