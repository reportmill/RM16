...
public RMLabels()
{
    double width = DEFAULT_LABEL_WIDTH*_numberOfColumns + _spacingWidth*(_numberOfColumns-1);
    double height = DEFAULT_LABEL_HEIGHT*_numberOfRows + _spacingHeight*(_numberOfRows-1);
...
public void setWidth(double aWidth)
{
    ...
    _spacingWidth = _spacingWidth*getWidth()/oldWidth;
}
...
public void setHeight(double value)
{
    ...
    _spacingHeight = _spacingHeight*getHeight()/h;
}
