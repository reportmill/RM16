 ...
 */
public static void writeShapeEffect(SGView aShape, RMPDFWriter aWriter)
{
 ...
 */
public static void writeBlurEffect(SGView aShape, BlurEffect aBlur, RMPDFWriter aWriter)
{
 ...
 */
public static void writeShadowEffect(SGView aShape, ShadowEffect aShadow, RMPDFWriter aWriter)
{
    // Get effect image and x/y and write
 ...
 */
private static void writeRefectionEffect(SGView aShape, ReflectEffect aReflect, RMPDFWriter aWriter)
{
 ...
 */
private static void writeEmbossEffect(SGView aShape, EmbossEffect anEmboss, RMPDFWriter aWriter)
{
 ...
 */
private static Image getEffectImage(SGView aShape)
{
    Effect eff = aShape.getEffect();
    Rect bnds = aShape.getBoundsStrokedDeep();
    PainterDVR pntr = new PainterDVR();
    aShape.paintAll(pntr);
