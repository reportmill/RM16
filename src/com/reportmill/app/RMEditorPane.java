...
public class RMEditorPane extends RMViewerPane {
    ...
    protected void initWindow(WindowView aWindow)
    {
        ...
        window.setCloseHandler(this::handleWindowCloseEvent);
        window.setMaximized(SnapEnv.isTeaVM || SnapEnv.isWebVM);
    }

    /**
     * Called when editor pane is set showing.
     */
    @Override
    ...
    public void runPopupMenu(ViewEvent anEvent)
    {
        ...
        if (selShape instanceof RMTextShape text) {
            ...
            Menu formatMenuCopy = (Menu) formatMenu.copyMenuItem();
        ...
        Menu shapesMenuCopy = (Menu) shapesMenu.copyMenuItem();
