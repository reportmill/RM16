...
public class KeysPanel extends EditorPane.SupportPane {
    ...
    public KeysPanel(EditorPane anEP)
    {
        ...
        for (String key : _builtInKeys)
            _builtInKeyNodes.add(new KeyNode(key));
    }
    ...
    public void configureKeysBrowserCell(ListCell <KeyNode> aCell)
    {
        ...
        if (knode!=null && knode._special)
            aCell.setFont(_keysBrowser.getFont().getBold());
    ...
    public void setKeysTableKey(String aKey)
    {
        ...
        // Set columns
        while (_keysTable.getColCount()>0)
            _keysTable.removeCol(0);
