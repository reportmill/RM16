...
public class RMSortPanel extends ViewOwner {
    ...
    public void resetUI()
    {
        ...
        _sortsTable.setSelIndex(grouping.getSelSortIndex()); //_sortsTable.repaint();
    ...
    public void respondUI(ViewEvent anEvent)
    {
        ...
        if (anEvent.equals("SortsTable")) {
            ...
            if (anEvent.isDragDrop()) {    //int toRow = _sortsTable.rowAtPoint(anEvent.getLocation());
                ...
                view.undoerSetUndoTitle("Add Sort Order");
            ...
            // Handle selection
                ...
                grouping.setSelSortIndex(row);

                // If selected sort order column, flip selected sort
                if (anEvent.isMouseRelease() && col==1) {
                    view.undoerSetUndoTitle("Flip Sort Ordering");
                    grouping.getSelSort().toggleOrder();
        ...
        if (anEvent.equals("RemoveSortMenuItem") && grouping.getSelSort()!=null) {
            view.undoerSetUndoTitle("Remove Sort Order");
            grouping.removeSort(grouping.getSelSort());
        }
        ...
        if (anEvent.equals("TopNKeyText")) {
            view.undoerSetUndoTitle("TopN Sort Change");
        ...
        if (anEvent.equals("TopNCountText")) {
            view.undoerSetUndoTitle("TopN Count Change");
    ...
    public interface Owner {
        ...
        // Returns the selected view that is being edited
