...
public class AppLoader {
    ...
    static final String JarName = "RMStudio16.jar";
    static final String JarURL = "http://reportmill.com/rm16/RMStudio16.jar"; // was .pack.gz
    static final String LoaderJarName = "AppLoader.jar"; // 
    static final String MainClass = "reportmill.app.App";
