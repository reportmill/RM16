...
public class RMGrouper implements Cloneable, XMLArchiver.Archivable {
    ...
    public RMGrouping removeGrouping(int anIndex)
    {
        ...
        _selGroupingIndex = Math.min(_selGroupingIndex, getGroupingCount() - 1);
     ...
     */
    public int getSelGroupingIndex()  { return _selGroupingIndex; }

    /**
     * Sets the currently selected grouping by index (for editing, mostly).
     */
    public void setSelGroupingIndex(int anIndex)  { _selGroupingIndex = anIndex; }

    /**
     * Returns the currently selected grouping (while editing only).
     */
    public RMGrouping getSelGrouping()  { return getGrouping(_selGroupingIndex); }
